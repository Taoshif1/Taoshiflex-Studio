...
export const site: SiteSettings = { name: "Taoshiflex Studio", description: "Strategy, design and engineering for ambitious businesses.", url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://taoshiflexstudio.me", location: "Dhaka, Bangladesh", email: "taoshif2@gmail.com" };

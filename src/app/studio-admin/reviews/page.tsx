...
export default async function ReviewsPage() {
  ...
  return <section className="admin-section"><header><p className="eyebrow">Studio Console / Reviews</p><h1>Client perspectives</h1><p>Moderate visibility while preserving every client’s original words.</p></header>{reviews === null ? <p>Reviews are unavailable. Verify the review migration is applied.</p> : <ReviewsAdmin reviews={reviews} projects={projects}/>}</section>;
}

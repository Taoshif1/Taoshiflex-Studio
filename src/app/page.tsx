...
export default function Home(){return <><Hero/><SelectedWork projects={projects}/><CapabilitySystem items={capabilities}/><Difference/><ProcessSystem stages={processStages}/><Studio/><FinalCta/></>}
